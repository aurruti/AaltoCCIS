...
date
echo "(all to www.taaf.fr/)"

echo "e.ext.nic.fr"
ping e.ext.nic.fr -c 5 -O -D | fgrep -e packets -e rtt
http-dig @e.ext.nic.fr www.taaf.fr/ | fgrep -e QUERY -e CURL | sed 's/;//g'

echo "g.ext.nic.fr"
ping g.ext.nic.fr -c 5 -O -D | fgrep -e packets -e rtt
http-dig @g.ext.nic.fr www.taaf.fr/ | fgrep -e QUERY -e CURL | sed 's/;//g'

echo "f.ext.nic.fr"
ping f.ext.nic.fr -c 5 -O -D | fgrep -e packets -e rtt
http-dig @f.ext.nic.fr www.taaf.fr/ | fgrep -e QUERY -e CURL | sed 's/;//g'
